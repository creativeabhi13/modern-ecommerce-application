    ...
    <>
      <section className="home-wrapper-1 py-5">
        <div className="container-xxl">
          <div className="row">
            ...
            <div className="col-6">
              <div className="d-flex flex-wrap gap-10 justify-content-between align-items-cneter">
                <div className="small-banner position-relative">
                  ...
                  <div className="small-banner-content position-absolute">
                    ...
                    <h5>Laptops Max</h5>
                    <p>
                      From ₹1,41,221.73 or <br /> ₹12500/month{" "}
                    </p>
                  </div>
                </div>
                <div className="small-banner position-relative">
                ...
                <div className="small-banner position-relative">
                  ...
                  <div className="small-banner-content position-absolute">
                    ...
                    <p>
                      {" "}
                      From ₹149,789.78 or <br /> ₹4583.33/month{" "}
                    </p>
                  </div>
                </div>
                <div className="small-banner position-relative">
                  ...
                  <div className="small-banner-content position-absolute">
                    ...
                    <h5>AirPods Max</h5>
                    <p>
                      High Fidelity Playbacks & <br />
                      Ultra-low disortions.{" "}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-12">
              <div className="services d-flex align-items-center justify-content-between">
                <div className="d-flex align-items-center gap-15">
                  ...
                  <div>
                    <h6>Free Shipping</h6>
                    <p className="mb-0">From all orders above ₹8000</p>
                  </div>
                </div>
                <div className="d-flex align-items-center gap-15">
      ...
      <section className="special-wrapper home-wrapper-2 py-5">
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
              <h3 className="section-heading">Special Products
              </h3>
            </div>
          </div>
          <div className="row ">
